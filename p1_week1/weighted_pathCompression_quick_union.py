#Trees are even more flat as compared to weighted_quick_union
#only one change required in the root function
#constant extra time but highly benificial in large scale
# theoritically this is not a linear algo but practically it almost is
...
class weighted_quick_union:
    ...
    def root(self, a):
        ...
        while(a != self.element_id[a][0]):
            self.element_id[a][0] = self.element_id[self.element_id[a][0]][0]
